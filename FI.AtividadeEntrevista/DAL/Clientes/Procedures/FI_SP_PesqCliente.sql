/* Nome da Procedure = FI_SP_PesqCliente */

If Object_ID('FI_SP_PesqCliente') Is Null
    Exec sp_executesql N'Create Procedure FI_SP_PesqCliente As Set Nocount On';
Go
...
BEGIN
	...
	SET @SCRIPT = 
	'SELECT ID, NOME, SOBRENOME, NACIONALIDADE, CEP, ESTADO, CIDADE, LOGRADOURO, EMAIL, TELEFONE, dbo.FI_FN_FormatarCPF(CPF) CPF FROM
